const translations = {
  en: {
    ...
    settings_appearance_desc: 'Choose your preferred color theme.',
    ...
    settings_language_desc: 'Choose the language Echo uses to talk with you.',
  ...
  es: {
    ...
    settings_appearance_desc: 'Elegí el tema de color que preferís.',
    ...
    settings_language_desc: 'Elegí el idioma en el que Echo te habla.',
