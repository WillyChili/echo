    ...
    <footer className="border-t border-white/[0.06] bg-[#050505] px-6 py-14">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {/* Center: Play Store */}
          <span
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-lg border border-white/[0.07] bg-white/[0.02] text-white/25 text-xs font-medium cursor-not-allowed select-none"
          >
          ...
          {/* X / Twitter — more prominent */}
          <a
            href="https://x.com/_ChiliWilly"
            target="_blank"
            rel="noreferrer"
            aria-label="Follow on X"
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg border border-white/[0.10] bg-white/[0.04]
              text-white/60 hover:text-white hover:border-white/25 hover:bg-white/[0.08]
